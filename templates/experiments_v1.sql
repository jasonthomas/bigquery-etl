-- Query generated by: templates/unnest_parquet_view.sql.py experiments_v1 telemetry_raw.experiments_v1
CREATE OR REPLACE VIEW
  `moz-fx-data-derived-datasets.telemetry.experiments_v1` AS
SELECT
...
FROM
  `moz-fx-data-derived-datasets.telemetry_raw.experiments_v1`
