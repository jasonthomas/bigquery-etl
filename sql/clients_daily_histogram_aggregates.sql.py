...
def _get_keyed_histogram_sql(probes):
    ...
    select_clause = """
        select
            ...
            >(metric, udf_get_histogram_type(bucket_range), key, '', udf_get_bucket_range(bucket_range), udf_aggregate_json_sum(value))
...
def get_histogram_probes_sql_strings(probes, histogram_type):
    ...
    for probe in probes:
        ...
        probe_structs.append(agg_string.format(
                metric=probe
            )
        )
